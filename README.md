...
* **Void Playtest Content:** This fork integrates with [The Void (Unofficial)](https://github.com/animalchubs/the-void-unofficial) and automatically searches its Void Features and Adversaries / Environments packs when installed. That adds lookup support for newer playtest material such as Blood Hunter, Assassin, Witch, Warlock, and related Void content.
